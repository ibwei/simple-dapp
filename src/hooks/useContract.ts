...
import { getStakerAddress, getMulticallAddress, getMjtAddress } from '../utils/addressHelpers'
...
export function useMjtContract(): Contract {
  return useContract(getMjtAddress(), MJT_ABI, true)
}
